...
fun GenderPicker(
    ...
    val maleSelectionAnim = animateFloatAsState(
        targetValue = if(selectedGender is Gender.Male) 80f else 0f,
        animationSpec = tween(durationMillis = 500),
        label = "maleSelectionAnim"
    )
    val femaleSelectionAnim = animateFloatAsState(
        targetValue = if(selectedGender is Gender.Female) 80f else 0f,
        animationSpec = tween(durationMillis = 500),
        label = "femaleSelectionAnim"
    )
                ...
                clipPath(
                    ...
                    drawCircle(
                        brush = Brush.radialGradient(
                            ...
                            radius = maleSelectionAnim.value + 1f
                        ),
                        radius = maleSelectionAnim.value,
                        center = untransformedMaleClickOffset
                    )
                }
            }
                ...
                clipPath(
                    ...
                    drawCircle(
                        brush = Brush.radialGradient(
                            ...
                            radius = femaleSelectionAnim.value + 1
                        ),
                        radius = femaleSelectionAnim.value,
                        center = untransformedFemaleClickOffset
                    )
                }
            }
